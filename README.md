# RestOnDB-RESTQL-Node

This is a NodeJS plug & play dynamic / automatic REST and GraphQL APIs on any relational database.
It uses the Express Framework with Sequalize ORM underneath for REST APIs and Postgraphile for GraphQL.
...
```bash
aws cloudformation delete-stack --stack-name db-service
```
